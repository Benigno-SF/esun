...
{
    public partial class Wfo_AprobRequ : System.Web.UI.Page
    {
        ...
        private void gvLoad() {
            ...
            GvList.Columns[10].Visible = (vnIdPerfil == 2) ? true: false ;
        }
        ...
        protected void btnGuardar_ServerClick(object sender, EventArgs e)
        {
            ...
            {
                EntHisp.vnId = Convert.ToInt32(GvList.DataKeys[row.RowIndex].Values[0].ToString());
                EntHisp.vnEstado = Convert.ToInt32(((HiddenField)row.FindControl("hdfValue")).Value);
                NegHisp.RegiEstadoRequerimiento(EntHisp);
            }
            gvLoad();
