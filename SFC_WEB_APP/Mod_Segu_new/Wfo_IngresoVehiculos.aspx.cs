...
namespace SFC_WEB_APP.Mod_Segu
{
    public partial class Wfo_IngresoVehiculos : System.Web.UI.Page
    {
        ...
        private void DdlTipoVehiculo()
        {
            entParm.vcCodigo = "";
            entParm.vcCodigoMaster = "02";
            nTipoVehiculo.DataSource = negParm.ListParametroGeneral(entParm);
            nTipoVehiculo.DataValueField = "cCodigo";
            nTipoVehiculo.DataTextField = "cDescripcion";
            nTipoVehiculo.DataBind();
            this.nTipoVehiculo.Items.Insert(0, new ListItem("Selecciona Tipo Vehiculo", "00"));
        }
