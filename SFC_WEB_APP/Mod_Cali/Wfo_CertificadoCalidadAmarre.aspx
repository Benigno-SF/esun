...
<asp:Content ID="Content5" ContentPlaceHolderID="Body" runat="server">
                ...
                <div class="modal-body">
                    <div class="mb-3" style="padding: 0px 6px;">
                        <table style="width: 100%" class="table table-bordered">
                            ...
                            <tr>                  
                                <td style="width: 50%" class=""><label class="col-form-label pb-0">LOTE PALTA:</label></td>
                                <td style="width: 50%" class=" sync0001_005"><button class="btn btn-icon SyncParame" idbusc="924" itembusc="004" idsel="0001_005"><i class="fas fa-sync"></i></button></td>
                            </tr>  
                            <!-- Agregamos campos para CITRICO   MILTON -->
                            <tr>                  
                                <td style="width: 50%" class=""><label class="col-form-label pb-0">LOTE CITRICO:</label></td>
                                <td style="width: 50%" class=" sync0001_0055"><button class="btn btn-icon SyncParame" idbusc="924" itembusc="008" idsel="0001_005"><i class="fas fa-sync"></i></button></td>
                            </tr> 
                            <!-- FIN Agregamos campos para CITRICO  MILTON  -->
                            <tr>                 
                                                ...
                                                <div class="card">
                                                    <div class="card-header text-black">
                                                        ...
                                                        <div class="row form-group" id="head_guia">
                                                            ...
                                                            <div class="form-group col-lg-3 col-md-4 col-sm-6 col-xs-12">
                                                                <label for="inputdefault" disabled="disabled" >Nom. Podador</label>
                                                    ...
                                                    <div class="card-header text-black">
                                                        ...
                                                        <div class="row form-group" id="head_transporte">
                                                            <div class="form-group col-lg-6 col-md-4 col-sm-6 col-xs-12">
                                                                <label for="inputdefault">Número de cargadores </label>
                                                                <input class="form-control" id="0002_001" type="number"/>
                                                            </div>
                                                            <div class="form-group col-lg-6 col-md-4 col-sm-6 col-xs-12">
                                                                <label for="inputdefault">Número de Amarre/Brazo</label>
                                                                <input class="form-control" id="0002_002" type="number" />
                                                            </div>
                                                        </div>
                                                    </div>

                                                     <div class="card-header text-black">
                                                        <h4 class="card-title text-uppercase">Amarre Correcto</h4>
                                                        <br />
                                                        <div class="row form-group" id="head_transporte">
                                                            <div class="form-group col-lg-6 col-md-4 col-sm-6 col-xs-12">
                                                                <label for="inputdefault">Amarre correcto </label>
                                                                <input class="form-control" id="0003_001" type="number" />
                                                            </div>
                                                            <div class="form-group col-lg-6 col-md-4 col-sm-6 col-xs-12">
                                                                <label for="inputdefault">Cargadores bien ubicados </label>
                                                                <input class="form-control" id="0003_002" type="number"  />
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="card-header text-black">
                                                        <h4 class="card-title text-uppercase">Mal Amarre</h4>
                                                        <br />
                                                        <div class="row form-group" id="head_transporte">
                                                            <div class="form-group col-lg-3 col-md-4 col-sm-6 col-xs-12">
                                                                <label for="inputdefault">Mal ubicado  </label>
                                                                <input class="form-control" id="0004_001" type="number"  />
                                                            </div>
                                                            <div class="form-group col-lg-3 col-md-4 col-sm-6 col-xs-12">
                                                                <label for="inputdefault">Cargadores rotos  </label>
                                                                <input class="form-control" id="0004_002" type="number" />
                                                            </div>
                                                            <div class="form-group col-lg-3 col-md-4 col-sm-6 col-xs-12">
                                                                <label for="inputdefault">Cargador por debajo del almabre </label>
                                                                <input class="form-control" id="0004_003" type="number" >
                                                            </div>
                                                            <div class="form-group col-lg-3 col-md-4 col-sm-6 col-xs-12">
                                                                <label for="inputdefault">Cargadores cruzados   </label>
                                                                <input class="form-control" id="0004_004" type="number" />
                                                            </div>
                                                            <div class="form-group col-lg-3 col-md-4 col-sm-6 col-xs-12">
                                                                <label for="inputdefault">Cargadores sin amarre   </label>
                                                                <input class="form-control" id="0004_005" type="number" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="card-header text-black">
                                                        ...
                                                        <div class="row form-group" id="head_transporte">
                                                            <div class="form-group col-lg-6 col-md-4 col-sm-6 col-xs-12">
                                                                ...
                                                                <input class="form-control" id="0005_001" type="text" />
                                                            </div>
                                                            <div class="form-group col-lg-6 col-md-4 col-sm-6 col-xs-12">
                                                                <label for="inputdefault">Observación 2 </label>
                                                                <input class="form-control" id="0005_002" type="text" />
                                                            </div>
                                                        </div>
                                                    </div>
    ...
    <script>
        ...
        function AddTemplate() {
            ...
            var acumulador = 0;
            // VALIDMAOS
            if ($("#0002_001").val() != null && $("#0002_001").val() >= 0 && $("#0002_001").val().length < 4) {
                if ($("#0002_002").val() != null && $("#0002_002").val() >= 0 && $("#0002_002").val().length < 4) {
                    if ($("#0003_001").val() != null && $("#0003_001").val() >= 0 && $("#0003_001").val().length < 4) {
                        if ($("#0003_002").val() != null && $("#0003_002").val() >= 0 && $("#0003_002").val().length < 4) {
                            if ($("#0004_001").val() != null && $("#0004_001").val() >= 0 && $("#0004_001").val().length < 4) {
                                if ($("#0004_002").val() != null && $("#0004_002").val() >= 0 && $("#0004_002").val().length < 4) {
                                    if ($("#0004_003").val() != null && $("#0004_003").val() >= 0 && $("#0004_003").val().length < 4) {
                                        if ($("#0004_004").val() != null && $("#0004_004").val() >= 0 && $("#0004_004").val().length < 4) {
                                            if ($("#0004_005").val() != null && $("#0004_005").val() >= 0 && $("#0004_005").val().length < 4) {
                                                ...
                                                row["7"] = { id: '0002_001', desc: $("#0002_001").val() };
                                                row["8"] = { id: '0002_002', desc: $("#0002_002").val() };
                                                // AMARRE CORRECTO 
                                                row["9"] = { id: '0003_001', desc: $("#0003_001").val() };
                                                row["10"] = { id: '0003_002', desc: $("#0003_002").val() };
                                                // AML AMARRE
                                                row["11"] = { id: '0004_001', desc: $("#0004_001").val() };
                                                row["12"] = { id: '0004_002', desc: $("#0004_002").val() };
                                                row["13"] = { id: '0004_003', desc: $("#0004_003").val() };
                                                row["14"] = { id: '0004_004', desc: $("#0004_004").val() };
                                                row["15"] = { id: '0004_005', desc: $("#0004_005").val() };
                                                // OBSERVAIONES
                                                row["16"] = { id: '0005_001', desc: $("#0005_001").val() };
                                                row["17"] = { id: '0005_002', desc: $("#0005_002").val() };
                                                datafr = row;
                                                var newformato_upd = [];
                                                var data_upd = new Array();
                                                for (var r = 0; r < FormatoDetalle.length; r++) {
                                                ...
                                                // FUJ DE CARGAR DTAOS  HACIALA BASE DATOS
                                            } else {
                                                toastr["error"]("Format Incorrecto de Cargadores sin amarre");
                                            }
                                        } else {
                                            toastr["error"]("Format Incorrecto de Cargadores cruzados");
                                        }
                                    } else {
                                        toastr["error"]("Format Incorrecto de Cargador por debajo del almabre");
                                    }
                                } else {
                                    toastr["error"]("Format Incorrecto de Cargadores rotos");
                                }
                            } else {
                                toastr["error"]("Format Incorrecto de Mal ubicado");
                            }
                        } else {
                            toastr["error"]("Format Incorrecto de Cargadores bien ubicados");
                        }
                    } else {
                        toastr["error"]("Format Incorrecto de Amarre correcto");
                    }
                } else {
                    toastr["error"]("Format Incorrecto de Número de Amarre/Brazo");
                }
            } else {
                toastr["error"]("Format Incorrecto de Número de cargadores");
            }
        ...
        function comprobarTextBoxLlenos() {
            console.log('si llega');
            var amarreCorrecto = $('#0003_001').val(),
                cargadoresBienUbicados = $('#0003_002').val(),
                malUbicado = $('#0004_001').val(),
                cargadoresRotos = $('#0004_002').val(),
                cargadorPorDebajoDelAlambre = $('#0004_003').val(),
                cargadoresCruzados = $('#0004_004').val(),
                cargadoresSinAmarre = $('#0004_005').val(),
                numeroCargadores = parseInt($('#0002_001').val());

            console.log(typeof amarreCorrecto, '        ', typeof cargadoresBienUbicados, '        ', typeof malUbicado, '        ', typeof cargadoresRotos, '        ', typeof cargadorPorDebajoDelAlambre, '        ', typeof cargadoresCruzados);
            if (numeroCargadores === (parseInt(amarreCorrecto) + parseInt(cargadoresBienUbicados) + parseInt(malUbicado) + parseInt(cargadoresRotos) + parseInt(cargadorPorDebajoDelAlambre) + parseInt(cargadoresCruzados) + parseInt(cargadoresSinAmarre))) {


                toastr["success"]("Datos bien calculados");
            } else if (numeroCargadores !== (parseInt(amarreCorrecto) + parseInt(cargadoresBienUbicados) + parseInt(malUbicado) + parseInt(cargadoresRotos) + parseInt(cargadorPorDebajoDelAlambre) + parseInt(cargadoresCruzados) + parseInt(cargadoresSinAmarre))) {
                toastr["error"]("Debes igualar los datos de la evaluación al número de Cargadores");
            }
        ...
        // EJEUTAMOS UNA ACCION  CON LOS INOUTS
        //const input1 = document.getElementById("0003_001");
        //input1.addEventListener('change', (event) => {
        //    var acumulador = 0;
        //    var valor1 = document.getElementById("0003_001").value;
        //    var valor2 = document.getElementById("0003_002").value;
        //    var valor3 = document.getElementById("0004_001").value;
        //    var valor4 = document.getElementById("0004_002").value;
        //    var valor5 = document.getElementById("0004_003").value;
        //    var valor6 = document.getElementById("0004_004").value;
        //    var valor7 = document.getElementById("0004_005").value;
        //    acumulador = Number(valor1) + Number(valor2) + Number(valor3) + Number(valor4) + Number(valor5) + Number(valor6) + Number(valor7);
        //    var valor8 = document.getElementById("0002_001").value;
        //    // hacemos vlaidcion simple
        //    if (Number(valor8) == acumulador) {
        //        acumulador = 0;
        //    } else {
        //        toastr["error"]("La suma no coincide con el numero de trabajadores");
        //    }
        //});
        //const input2 = document.getElementById("0003_002");
        ...
        //    }
        //});
        //const input3 = document.getElementById("0004_001");
        ...
        //    }
        //});
        //const input4 = document.getElementById("0004_002");
        ...
        //    }
        //});
        //const input5 = document.getElementById("0004_003");
        ...
        //    }
        //});
        //const input6 = document.getElementById("0004_004");
        ...
        //    }
        //});
        const input7 = document.getElementById("0004_005");
