<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Wfo_CertificadoCalidadPoda.aspx.cs" Inherits="SFC_WEB_APP.Mod_Cali.Wfo_CertificadoCalidadPoda" %>
...
<asp:Content ID="Content5" ContentPlaceHolderID="Body" runat="server">
    ...
    <div class="modal" id="ModNewCertificado" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" data-modal-parent="#ModOrden">
                        ...
                        <div class="container card" style="width: 100%">
                            ...
                            <div class="tab-content" id="myTabContent">
                                <div class="tab-pane fade show active" id="inf" role="tabpanel" aria-labelledby="inf-tab" style="min-height: 70vh">
                                    <div class="form-group pb-0 m-0" id="ocultar_campos1">
                                    ...
                                    <div class="form-group mb-2" id="ocultar_campos10">
                                    ...
                                    <div class="form-group mb-2" id="ocultar_campos11">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="card">
                                                    <div class="card-header text-black">
                                                        ...
                                                        <div class="row form-group" id="head_guia">
                                                            ...
                                                            <div class="form-group col-lg-3 col-md-4 col-sm-6 col-xs-12">
                                                                <label for="inputdefault">Podador DNI</label>
                                                                <input class="form-control" maxlength="8" id="0001_008" type="text" oninput="buscarNombrePorDni()"/>
                                                            </div>
                                                            <div class="form-group col-lg-3 col-md-4 col-sm-6 col-xs-12">
                                                                <label for="inputdefault">Nom. Podador</label>
                                                                <input class="form-control" id="0001_009" type="text" disabled="disabled"/>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="card-header text-black">
                                                        <h4 class="card-title text-uppercase">Pauta</h4>
                                                        <br />
                                                        <div class="row form-group" id="head_transporte">
                                                            <div class="form-group col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                                                <label for="inputdefault">Nro. Cargadores</label>
                                                                <input class="form-control nCargadores" id="0001_010" type="text" />
                                                            </div>
                                                            <div class="form-group col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                                                <label for="inputdefault">Nro. Yemas</label>
                                                                <input class="form-control nYemas" id="0001_011" type="text" />
                                                            </div>
                                                            <div class="form-group col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                                                <label for="inputdefault">Objetivo del día/Plantas</label>
                                                                <input class="form-control" id="0001_012" type="text" />
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="card-header text-black">
                                                        <h4 class="card-title text-uppercase">Evaluación de Cargadores</h4>
                                                        <br />
                                                        <div class="row form-group" id="head_detalle">
                                                            <div class="form-group col-lg-3 col-md-4 col-sm-6 col-xs-12">
                                                                <label for="inputdefault">Debil</label>
                                                                <input class="form-control debil" id="0002_001" type="number" max="999" min="0"/>
                                                            </div>
                                                            <div class="form-group col-lg-3 col-md-4 col-sm-6 col-xs-12">
                                                                <label for="inputdefault">Yemas Cargador (Debil)</label>
                                                                <input class="form-control nYemasCargadorDebil" id="0002_002" type="number" max="999" min="0"/>
                                                            </div>
                                                            <div class="form-group col-lg-3 col-md-4 col-sm-6 col-xs-12">
                                                                <label for="inputdefault">Normal</label>
                                                                <input class="form-control normal" id="0002_003" type="number" max="999" min="0"/>
                                                            </div>
                                                            <div class="form-group col-lg-3 col-md-4 col-sm-6 col-xs-12">
                                                                <label for="inputdefault">Yemas Cargador (Normal)</label>
                                                                <input class="form-control nYemasCargadorNormal" id="0002_004" type="number" max="999" min="0"/>
                                                            </div>
                                                            <div class="form-group col-lg-3 col-md-4 col-sm-6 col-xs-12">
                                                                <label for="inputdefault">Vigoroso</label>
                                                                <input class="form-control vigoroso" id="0002_005" type="number" max="999" min="0"/>
                                                            </div>
                                                            <div class="form-group col-lg-3 col-md-4 col-sm-6 col-xs-12">
                                                                <label for="inputdefault">Yemas Cargador (Vigoroso)</label>
                                                                <input class="form-control nYemasCargadorVigoroso" id="0002_006" type="number" max="999" min="0"/>
                                                            </div>
                                                            <div class="form-group col-lg-3 col-md-4 col-sm-6 col-xs-12">
                                                                <label for="inputdefault">Total de Cargadores</label>
                                                                <input class="form-control totalCargadores" id="0002_007" type="number" max="999" min="0" disabled/>
                                                            </div>
                                                            <div class="form-group col-lg-3 col-md-4 col-sm-6 col-xs-12">
                                                                <label for="inputdefault">Total de Yemas</label>
                                                                <input class="form-control totalYemas" id="0002_008" type="number" max="999" min="0" disabled/>
                                                            </div>
                                                            <div class="form-group col-lg-3 col-md-4 col-sm-6 col-xs-12">
                                                                <label for="inputdefault">Cumplimiento/Pauta Cargadores</label>
                                                                <input class="form-control totalPautaCargadores" id="0002_009" type="number" max="999" disabled/>
                                                            </div>
                                                            
                                                            <div class="form-group col-lg-3 col-md-4 col-sm-6 col-xs-12">
                                                                <label for="inputdefault">Motivo del Faltante</label>
                                                                <select class="custom-select" id="0002_010">
                                                                    <option selected="selected">Seleccione...</option>
                                                                    <option value="1">Por cultivo</option>
                                                                    <option value="2">Por podador</option>
                                                                    <option value="3">No presenta</option>
                                                                </select>
                                                            </div>
                                                            ...
                                                            <script>
                                                                ...
                                                                $('.debil').on('keyup', function () {

                                                                    var debil = $('.debil').val();
                                                                    var normal = $('.normal').val();
                                                                    var vigoroso = $('.vigoroso').val();
                                                                    //alert(typeof debil + '    ' + debil);
                                                                    //alert(typeof normal + '    ' + normal);
                                                                    //alert(typeof vigoroso + '    ' + vigoroso);

                                                                    if (debil != '') {
                                                                        debil = Math.trunc(Math.abs(parseInt($('.debil').val())));
                                                                    }

                                                                    if (normal != '') {
                                                                        normal = Math.abs(parseInt($('.normal').val()));
                                                                    }

                                                                    if (vigoroso != '') {
                                                                        Math.abs(vigoroso = parseInt($('.vigoroso').val()));
                                                                    }

                                                                    var total = debil + normal + vigoroso;
                                                                    $('.totalCargadores').val(total);

                                                                    var nYemasVigoroso = $('.nYemasCargadorVigoroso').val();
                                                                    var nYemasNormal = $('.nYemasCargadorNormal').val();
                                                                    var nYemas = $('.nYemas').val();
                                                                    if (nYemasVigoroso != '') {
                                                                        nYemasVigoroso = parseInt($('.nYemasCargadorVigoroso').val());
                                                                    }
                                                                    if (nYemasNormal != '') {
                                                                        nYemasNormal = parseInt($('.nYemasCargadorNormal').val());
                                                                    }
                                                                    if (nYemas != '') {
                                                                        nYemas = parseInt($('.nYemas').val());
                                                                    }
                                                                    var total2 = (vigoroso * nYemasVigoroso) + (normal * nYemasNormal) + (debil * nYemas);

                                                                    $('.totalYemas').val(total2);
                                                                    validarPauta();
                                                                ...
                                                                $('.normal').on('keyup', function () {
                                                                    ...
                                                                    if (debil != '') {
                                                                        debil = Math.abs(parseInt($('.debil').val()));
                                                                    }
                                                                    ...
                                                                    if (vigoroso != '') {
                                                                        vigoroso = Math.abs(parseInt($('.vigoroso').val()));
                                                                    }
                                                                    ...
                                                                    var nYemas = $('.nYemas').val();
                                                                    if (nYemasVigoroso != '') {
                                                                        nYemasVigoroso = Math.abs(parseInt($('.nYemasCargadorVigoroso').val()));
                                                                    }
                                                                    if (nYemasNormal != '') {
                                                                        nYemasNormal = Math.abs(parseInt($('.nYemasCargadorNormal').val()));
                                                                    }
                                                                    if (nYemas != '') {
                                                                        nYemas = Math.abs(parseInt($('.nYemas').val()));
                                                                    }
                                                                    var total2 = (vigoroso * nYemasVigoroso) + (normal * nYemasNormal) + (debil * nYemas);
                                                                ...
                                                                $('.nYemasCargadorVigoroso').on('keyup', function () {
                                                                    var vigoroso = $('.vigoroso').val();
                                                                    var nYemasVigoroso = $('.nYemasCargadorVigoroso').val();
                                                                    var normal = $('.normal').val();
                                                                    var nYemasNormal = $('.nYemasCargadorNormal').val();
                                                                    ...
                                                                    var total = (vigoroso * nYemasVigoroso) + (normal * nYemasNormal) + (debil * nYemas);

                                                                    $('.totalYemas').val(total);
                                                                    validarPauta();
                                                                });

                                                                $('.nYemasCargadorNormal').on('keyup', function () {
                                                                    var vigoroso = $('.vigoroso').val();
                                                                    var nYemasVigoroso = $('.nYemasCargadorVigoroso').val();
                                                                    var normal = $('.normal').val();
                                                                    var nYemasNormal = $('.nYemasCargadorNormal').val();
                                                                ...
                                                                $('.nCargadores').on('keyup', function () {
                                                                    var totalCargadores = $('.totalCargadores').val();
                                                                    var nCargadores = $('.nCargadores').val();

                                                                    if (totalCargadores != '') {
                                                                        totalCargadores = Math.abs(parseInt($('.totalCargadores').val()));
                                                                    }
                                                                    if (nCargadores != '') {
                                                                        nCargadores = Math.abs(parseInt($('.nCargadores').val()));
                                                                    }
                                                                    var total = totalCargadores - nCargadores;

                                                                    $('.totalPautaCargadores').val(total);
                                                                    validarPauta();
                                                                });
                                                                ...
                                                                function validarPauta() {
                                                                    ...
                                                                    if (totalCargadores != '') {
                                                                        totalCargadores = parseInt($('.totalCargadores').val());
                                                                    }
                                                                    if (nCargadores != '') {
                                                                        nCargadores = parseInt($('.nCargadores').val());
                                                                    }
                                                                    var total = totalCargadores - nCargadores;
                                                    ...
                                                    <div class="card-header text-black">
                                                        <h4 class="card-title text-uppercase">Limpieza</h4>
                                                        <br />
                                                        <div class="row form-group" id="head_transporte">
                                                            <div class="form-group col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                                                <label for="inputdefault">Hojas</label><br />
                                                                <input type="hidden" id="0003_001" />
                                                                <input type="radio" name="grupoHoja" id="hojaSi" onclick="verificarGrupoHoja()" value="Si presenta" /><label style="margin-left:5px;" for="hojaSi">Si presenta </label><br />
                                                                <input type="radio" name="grupoHoja" id="hojaNo" onclick="verificarGrupoHoja()"  value="No presenta"  /><label style="margin-left:5px;" for="hojaNo">No presenta </label><br />
                                                            </div>
                                                            <div class="form-group col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                                                <label for="inputdefault">Zarcillos</label><br />
                                                                <input type="hidden" id="0003_002" />
                                                                <input type="radio" name="grupoZarcillo" id="zarcilloSi" onclick="verificarGrupoZarcillo()" value="Si presenta" /><label style="margin-left:5px;" for="zarcilloSi">Si presenta </label><br />
                                                                <input type="radio" name="grupoZarcillo" id="zarcilloNo" onclick="verificarGrupoZarcillo()" value="No presenta" /><label style="margin-left:5px;" for="zarcilloNo">No presenta </label><br />
                                                            </div>
                                                            <div class="form-group col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                                                <label for="inputdefault">Ramas</label><br />
                                                                <input type="hidden" id="0003_003" />
                                                                <input type="radio" name="grupoRamas" id="ramasSi" onclick="verificarGrupoRamas()" value="Si presenta" /><label style="margin-left:5px;" for="ramasSi">Si presenta </label><br />
                                                                <input type="radio" name="grupoRamas" id="ramasNo" onclick="verificarGrupoRamas()" value="No presenta" /><label style="margin-left:5px;" for="ramasNo">No presenta </label><br />
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="card-header text-black">
                                                        ...
                                                        <br />
                                                        <div class="row form-group" id="head_observacion">
                                                            <div class="form-group col-lg-6 col-md-4 col-sm-6 col-xs-12">
                                                                <label for="inputdefault">Observacion 1</label>
                                                                <input class="form-control" id="0004_001" type="text" />
                                                            </div>
                                                            <div class="form-group col-lg-6 col-md-4 col-sm-6 col-xs-12">
                                                                <label for="inputdefault">Observacion 2</label>
                                                                <input class="form-control" id="0004_002" type="text" />
                                                            </div>
                                                        </div>
    ...
    <script>
        ...
        function verificarGrupoHoja() {
            var radioHoja = $('input[name=grupoHoja]:checked').val();
            $('#0003_001').val(radioHoja);
        }
        function verificarGrupoZarcillo() {
            var radioZarcillo = $('input[name=grupoZarcillo]:checked').val();
            $('#0003_002').val(radioZarcillo);
        }
        function verificarGrupoRamas() {
            var radioRama = $('input[name=grupoRamas]:checked').val();
            $('#0003_003').val(radioRama);
        }
        ...
        $(document).on('click', '#sync_parametros', function (e) {
            e.preventDefault();
            Load_Datos('924', '011', '0001_002', 'descripcion', 'descripcion');
            Load_Datos('924', '010', '0001_003', 'descripcion', 'descripcion');
            Load_Datos('924', '012', '0001_004', 'descripcion', 'descripcion');
            Load_Datos('924', '013', '0001_005', 'descripcion', 'descripcion');
            Load_Datos('004', '001', '0001_006', 'descripcion', 'descripcion');
            //Load_Datos('924', '009', '0002_001', 'descripcion', 'descripcion', 1);

            toastr.success('', 'Paràmetros sincronizados');
        ...
        //CARGAR FORMATOS   FUNCION CARGAR DATOS DE LSO FORMATOS LA INICIO...
        var formato_to = [];
        function Load_Formatos() {
            // limpiamos el formsto de local estore  ---------------------------------------------------- milton
            localStorage.removeItem("objFormatos");
            localStorage.clear();
        ...
        //CARGA FORMATO DETALLE ACTUAliZAR  ---FUNCJION POARAREDIRECCIO0ANR LOS PLANTILAS CREDAS .....
        var FormatoDetalle = [];
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (accion == 1) {
                        ...
                        $('#head_cal').hide();
                        $('#Tablas_cal').hide();
                        // validacion de coultar y mostra modal -- ccanviado ---------------------------------------------------------------------------- MILTON
                        //$('#Plantilla_uva_agu2').show();
                        //$('#Plantilla_uva_agu1').show();
                        $('#Plantilla_cal').show();

                        //cambios de Erick = que a partir del segundo item de evaluacion, la pauta aparezca disableada con el itemd
                        if (itemd !== "001") {
                            $('#0001_002').dxSelectBox({ disabled: true, });
                            $('#0001_003').dxSelectBox({ disabled: true, });
                            $('#0001_004').dxSelectBox({ disabled: true, });
                            $('#0001_005').dxSelectBox({ disabled: true, });
                            $('#0001_006').dxSelectBox({ disabled: true, });
                            $('#0001_008').attr('disabled', 'disabled');
                            $('#0001_010').attr('disabled', 'disabled');
                            $('#0001_011').attr('disabled', 'disabled');
                            $('#0001_012').attr('disabled', 'disabled');
                        }
                        else {
                            $('#0001_002').dxSelectBox({ disabled: false, });
                            $('#0001_003').dxSelectBox({ disabled: false, });
                            $('#0001_004').dxSelectBox({ disabled: false, });
                            $('#0001_005').dxSelectBox({ disabled: false, });
                            $('#0001_006').dxSelectBox({ disabled: false, });
                            $('#0001_008').removeAttr('disabled');
                            $('#0001_010').removeAttr('disabled');
                            $('#0001_011').removeAttr('disabled');
                            $('#0001_012').removeAttr('disabled');
                        }
                        //fin cambios de Erick

                        for (var i = 0; i < lst.length; i++) {
                            //console.log(lst[i].ITEMD + ' ' + itemd + ' ' + lst[i].TIPODATO + ' ' + lst[i].ES_BUSCADOR);
                            if (lst[i].ITEMD.trim() == itemd) {
                                if (lst[i].TIPODATO == 'N') {
                                    if (lst[i].ITEMREF != '') {
                                    ...
                                    if (lst[i].ES_BUSCADOR == 1) {
                                        ...
                                        if (lst[i].ESTRUCTURA.trim() == '0001_008') {
                                            ...
                                            if (lst[i].ESTRUCTURA.trim() == '0003_001') {
                                                if (lst[i].RESULTADO_OI=='Si presenta') {
                                                    $("#hojaSi").attr('checked', 'checked');
                                                    console.log('si');
                                                }
                                                else{
                                                    $("#hojaNo").prop("checked", true);
                                                    console.log('no');
                                                }
                                            }
                                            if (lst[i].ESTRUCTURA.trim() == '0003_002') {
                                                if (lst[i].RESULTADO_OI == 'Si presenta') {
                                                    $("#zarcilloSi").attr('checked', 'checked');
                                                    console.log('si');
                                                }
                                                else {
                                                    $("#zarcilloNo").prop("checked", true);
                                                    console.log('no');
                                                }
                                            }
                                            if (lst[i].ESTRUCTURA.trim() == '0003_003') {
                                                if (lst[i].RESULTADO_OI == 'Si presenta') {
                                                    $("#ramasSi").attr('checked', 'checked');
                                                    console.log('si');
                                                }
                                                else {
                                                    $("#ramasNo").prop("checked", true);
                                                    console.log('no');
                                                }
                                            }
        ...
        $(document).on('click', '.AddMuestraPlus', function (e) {
            ...
            EditEvaluacion('001', getCookie('puk_idvariable'), idc, '', 0);
        ...
        $(document).on('click', '#RegistrarMuestra', function (e) {
            ...
            for (var t = 0; t < FormatoDetalle.length; t++) {
                ...
                if (FormatoDetalle[t].ITEMD.trim() == '001') {
                    ...
                    if (FormatoDetalle[t].ESTRUCTURA.trim() == '0003_001' || FormatoDetalle[t].ESTRUCTURA.trim() == '0003_002' || FormatoDetalle[t].ESTRUCTURA.trim() == '0003_003' || FormatoDetalle[t].ESTRUCTURA.trim() == '0002_001') {
        ...
        function AddTemplate() {
            ...
            var acumulador = 0;
            // VALIDMAOS                    
            // CARGAMOS DTA HACIA LA BASE DE DATOS
            // obtenmos la fehc actual
            ...
            // cabcera  datos  
            row["0"] = { id: '0001_001', desc: fecha_actual };
            ...
            row["9"] = { id: '0001_011', desc: $("#0001_011").val() };

            row["10"] = { id: '0001_012', desc: $("#0001_012").val() };



            row["11"] = { id: '0002_001', desc: $("#0002_001").val() };

            row["12"] = { id: '0002_002', desc: $("#0002_002").val() };


            row["13"] = { id: '0002_003', desc: $("#0002_003").val() };

            row["14"] = { id: '0002_004', desc: $("#0002_004").val() };

            row["15"] = { id: '0002_005', desc: $("#0002_005").val() };

            row["16"] = { id: '0002_006', desc: $("#0002_006").val() };

            row["17"] = { id: '0002_007', desc: $("#0002_007").val() };

            row["18"] = { id: '0002_008', desc: $("#0002_008").val() };


            row["19"] = { id: '0002_009', desc: $("#0002_009").val() };


            row["20"] = { id: '0002_010', desc: $("#0002_010").val() };
            ...
            row["24"] = { id: '0004_001', desc: $("#0004_001").val() };

            row["25"] = { id: '0004_002', desc: $("#0004_002").val() };
            ...
            // alert(JSON.stringify(Productos))<a href="Wfo_RepCalidad.aspx">Wfo_RepCalidad.aspx</a>
        };
        //AGREGAR ACTUALIZACION -UVA
        ...
        //function agregarFechaAlDetalleDelDetalle(fecha, idCertificado) {
        //    var obj = new Object();
        //    obj.vidcertificado = idCertificado;
        //    obj.vcFecha = fecha;
        //    $.ajax({
        //        type: 'POST',
        //        url: "../SerCertCalidad.asmx/ActualizarFechaDetalleDetalle",
        //        data: JSON.stringify({ obj: obj }),
        //        dataType: 'json',
        //        contentType: 'application/json; charset=utf-8',
        //        success: function (data) {
        ...
        function AddNewCertificado() {
            ...
            objadd.vidcertificado = $('#pkid').val().trim();
            ...
            if ($('#fecha').val() != '') {
                ...
                var oobjju = new Object();
                oobjju.fecha = str2.trim();
                oobjju.certificado = objadd.vidcertificado.trim();
                console.log(oobjju);
            } else {
                objadd.vcFecha = '';
                if (fechaparse != '') {
        ...
        //CAMBIOS DE ERICK: AGREGAR LA FECHA AL DETALLE DEL DETALLE DEL CERTIFICADO, CON UN NUEVO PROCEDURE QUE ACTUALIZA LA TABLA DE DETALLES DE DETALLES SOLO EL CAMPO DE LA FECHA
        ...
        function Load_Variable(idusuario) {
            //localStorage.removeItem("objVAR");
            var obj = new Object();
            obj.vidempresa = '001';
        ...
        //CARGAR PARAMETROS  --------------------------------MILTON AUIETAR VLAORTES DE NUEOV   PNATILLA
        ...
        function carga_input_head() {
            ...
            //Load_Datos_Head('AGU1', 'idvariable', 'descripcion', getCookie("puk_idvariable"));
        }
        ...
        // caragmos data de los sleect neuvo creados  -----------------------------------------------------------MILTON



        //CARGAR PRODUCTOS
        function Load_ProductosCalidad() {
            // setemnao los de prudctos tambien  .-----------------------------------------------------MILTON
        ...
        function adx_mstrax() {
            ...
            det_add += '<tr style="visibility:collapse;"><td style = "width: 85%; text-align: left; vertical-align: middle;" >CANTIDAD</td><td style="width: 15%;text-align: right;"><input class="cantmuetra" type="number" value="' + 0 + '"></td></tr>';
            det_add += '<tr style="visibility:collapse;"><td style = "width: 85%; text-align: left; vertical-align: middle;" >CANTIDAD DE MUESTRA</td><td style="width: 15%;text-align: right;"><input class="cantdemuetra" type="number" value="' + 0 + '"></td></tr>';
            det_add += '</table>';
            det_add += '</div>';
                    ...
                    success: function (data) {
                        ...
                        if (lst.length != 0) {
                            ...
                            for (var i = 0; i < lst2.length; i++) {
                                ...
                                // VALIDMAOS  LOS PARAMETROS  DE COSECHAS....
                                var cosechador = "";
                                if (lst[i].glosa == null) {
                                    cosechador = "SIN ASIGNAR";
                                } else {
                                    cosechador = lst[i].glosa;
                                }
                                ...
                                var date = new Date(lst[i].fecha); // create Date object
                                ...
                                tabc += '<tr style="border-bottom: 1px solid #fff;"><td style = "width: 35%; text-align: left;" >PODADOR:</td><td style="width: 65%;text-align: right;">' + cosechador + '</td></tr>';
                                tabc += '</table>';
                                tabc += '</div>';
                                tabc += '</div></div>';
                                ...
                                html += "<div class='panel-heading  card-cal panel-cal' role='tab' id='DvHead" + lst2[i].idcertificado + "'>"
                                html += "<a role='button' data-toggle='collapse' data-parent='#accordion' href='#DvBody" + lst2[i].idcertificado + "' aria-expanded='false' aria-controls='DvBody" + lst2[i].idcertificado + "' class='collapsed'>"
                                html += "<div class='panel-title'>" + tabc + "</div></a> </div>";
                                html += "<div id='DvBody" + lst2[i].idcertificado + "' class='panel-collapse collapse' role='tabpanel' aria-labelledby='DvHead" + lst2[i].idcertificado + "' aria-expanded='false' style='height: 0px;'>"
                                html += "<div class='panel-body' id='dvBodyC" + lst2[i].idcertificado + "' style='background-color: #d6e2d621;'><div class='table-responsive'>";
