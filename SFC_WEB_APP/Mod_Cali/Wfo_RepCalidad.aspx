<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Wfo_RepCalidad.aspx.cs" Inherits="SFC_WEB_APP.Mod_Cali.Wfo_RepCalidad" %>
...
<asp:Content ID="Content5" ContentPlaceHolderID="Body" runat="server">
        ...
        <div class="form-group col-xs-6 col-sm-6 col-md-6 col-lg-2 pb-0 mb-0" style="" id="DivFeIni">
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Reporte Reparaciones</h4>
    ...
    <script>
        ...
        function cargatabla() {
            ...
            if (obj.vcIdEmpresa != '') {
                ...
                $.ajax({
                    type: 'POST',
                    url: "../SerMaes.asmx/InformeReparaciones_List",
