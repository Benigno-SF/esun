...
<asp:Content ID="Content5" ContentPlaceHolderID="Body" runat="server">
                                        ...
                                        <div id="collapseOne" class="collapse" aria-labelledby="headingOne" data-parent="#accordionExample">
                                            <div class="card-body border border-1 ajustarps">
                                                ...
                                                <ul class="nav nav-tabs" id="myTab" role="tablist">
                                                    ...
                                                    <li class="nav-item" role="presentation">
                                                        <a class="nav-link" id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile" aria-selected="false" onclick="listar_labores2();">LABORES </a>
                                                    </li>
                                                </ul>
                                                <div class="tab-content border-bottom" id="myTabContent">
                                                                    ...
                                                                    <div class="col-xl-12">
                                                                        <div class="row">
                                                                            <div class="col-sm-1 col-md-3 mt-2">
                                                                                <!--<div id="gResponsableSuperior2" class="form-control"></div>-->
                                                                                 <input type="number" id="dniResponsable" class="form-control" placeholder="Ingrese DNI" />
                                                                            </div>
                                                    ...
                                                    <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                                                        ...
                                                        <ul class="nav nav-tabs mt-3" id="myTab" role="tablist">
                                                            <li class="nav-item" role="presentation">
                                                                <a class="nav-link active" id="home-tab6" data-toggle="tab" href="#home2" role="tab" aria-controls="home" aria-selected="true" onclick="listar_labores2();"><b>L. Labores</b></a>
                                                            </li>
                                                            <li class="nav-item" role="presentation">
                                                            ...
                                                            <li class="nav-item" role="presentation">
                                                                <a class="nav-link" id="contact-tab5" data-toggle="tab" href="#rendmiento_2" role="tab" aria-controls="contact" aria-selected="false" onclick="listar_trabajador_labor();"><b>Rend/Avance Labor</b></a>
                                                            </li>
                                                        </ul>
                                                        <div class="tab-content border-bottom" id="myTabContent">
                                                            ...
                                                            <div class="tab-pane fade" id="rendmiento_2" role="tabpanel" aria-labelledby="contact-tab5">
                                                                ...
                                                                <div class="col-md-12 bg-white">
                                                                    <div class="d-flex justify-content-end mb-2 input-group">
                                                                        <input type="text" class="form-control" onkeypress="buscarDniEnRendimiento();" placeholder="Ingrese el nmbre" id="buscarDniTrabajadorGrupo" />
    ...
    <script>
        window.addEventListener('load', function () {
            ...
            //        document.getElementById("responsable_usuario").value = lst[0].IDPERSONAL;
            //        var searchBox = $("#gResponsableSuperior2").dxSelectBox({
            //            dataSource: lst,
            //            displayExpr: 'NOMBRE',
            ...
            var obj2 = new Object();
            obj2.vrgempresa = cod_empresa;
            obj2.vrgbaseddatos = bd;
            obj2.vrgtipo = tipo;
            obj2.vridactividad = '';
            obj2.vrgfecha = fecha_actual;
            obj2.vrusuario = "";
            $.ajax({
                type: 'POST',
                url: "../SerTareo.asmx/SER_listar_labor_combinaciones",
                ...
                success: function (data) {
                    ...
                    if (lst.length === 0) {
                        ...
                        for (var i = 0; i < lst.length; i++) {
                            ...
                            list_grupo += '<label><b>Tareador:</b> </label>';
        ...
        function listar_data_usuario() {
            //var dni = $("#gResponsableSuperior2").dxSelectBox('instance').option('selectedItem').IDPERSONAL;
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (lst.length === 0) {
                        ...
                        //document.getElementById("gResponsableSuperior2").value = "";
                        document.getElementById("dniResponsable").value = "";
                    } else {
        ...
        function registrar_grupos(dni, datos) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    document.getElementById("reg_grupo_envase").value = "";
        ...
        function listar_grupo() {
            ...
            $.ajax({
                ...
                success: function (data) {
                    var lst = JSON.parse(data.d);
                    if (lst.length > 0) {
                        almacenarLocalStorage('idGrupo', lst[0].IDGT);
                        ...
                        for (var i = 0; i < lst.length; i++) {
                            ...
                            list_grupo += '<a class="medellin" onclick="listar_detalle(' + String(valorALaLuz) + ');">';
                            ...
                            //list_grupo += '<img src="' + lst[i].PERSONAL_FOTO +'" width="100" heigth="100">';
                            list_grupo += '</h1>';
                            list_grupo += '</div>';
                            list_grupo += '</div>';
                            ...
                            list_grupo += '<button type="button" class="btn btn-danger btn-md eliminarGrupo" id="id_btn_elim_grupo" onclick="eliminar_grupo(' + lst[i].IDGT + ');">';
        ...
        function eliminar_grupo(id) {
            Swal.fire({
                icon: 'error',
                title: 'ATENCIÓN, ESTAS POR BORRAR UN GRUPO',
                text: 'Si estas completamente seguro de eliminar el grupo, dale en ELIMINAR',
                showDenyButton: true,
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    for (var i = 0; i < lst.length; i++) {
                        ...
                        almacenarLocalStorage('idResponsableble', lst[i].COD_RESP);
                        var trow = '';
                        ...
                        trow += '<p class="card-text text-dark">' + lst[i].META + ' ' + lst[i].descripcion_envase + '</p>';
                        trow += '</div>';
                        trow += '</div>';
        ...
        //    var vtitem_ini = localStorage.getItem('num_combinacion');
        //    var idResponsable = '';
        ...
        //    obj.vtareocabfecha = fecha_filtro;
        //    obj.vtareocabtipo = tipo;
        //    obj.vtitem_ini = vtitem_ini;
        //    obj.idResponsable = localStorage.getItem('idResponsableble');
        //    console.log(obj);
        //    //obj.idResponsable = ;
        //    $.ajax({
        //        type: 'POST',
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (lst.length > 0) {
                        ...
                        for (var i = 0; i < lst.length; i++) {
                            list_grupo = '';
                            //list_grupo += '<a onclick="redireccionar(' + lst[i].TIPO2 + ',' + lst[i].CITEM + ');" dniresponsable="' + lst[i].CIDRESPONSABLE + '" nrogrupo="' + lst[i].IDGT + '">';
                            list_grupo += '<a class="redireccionar" idtipo="' + lst[i].TIPO2 + '" iditem="' + lst[i].CITEM + '" dniresponsable="' + lst[i].CIDRESPONSABLE + '" nrogrupo="' + lst[i].IDGT + '">';
                            list_grupo += '<div class="col-xl-12 mt-2  rounded border-left-3 border-warning">';
                            list_grupo += '<div class=" text-dark ">';
                            ...
                            list_grupo += '<div class="col-sm-2">';
                            list_grupo += '<label class="form-label"><b></b></label>';
                            list_grupo += '<label class="form-label" id="idgrupo" style="font-weight: bold;">' + lst[i].CDESCGRUPO + '</label>';
                            list_grupo += '</div>';
                            list_grupo += '<div class="col-sm-1">';
                            list_grupo += '<label class="form-label"><b>Nª</b></label>';
                            list_grupo += '<label class="form-label" id="idgrupo">' + lst[i].CITEM + '</label>';
        ...
        $(document).on('click', '.redireccionar', function (e) {
            e.preventDefault();

            var item = $(this).attr('iditem');
            var dni = $(this).attr('dniresponsable');
            var idtipo = $(this).attr('idtipo');
            var idGrupo = $(this).attr('nrogrupo'); 
            almacenarLocalStorage('num_combinacion', item);
            almacenarLocalStorage('idGrupo', idGrupo);
            almacenarLocalStorage('idResponsableble', dni);
            almacenarLocalStorage('tipoLabor', idtipo);
        ...
        function listar_trabajador_x_labor() {
            ...
            var obj1 = new Object();
            obj1.vusuario = usuario;
            obj1.vtfehcagrupo = fecha_actual;
            obj1.vtipo = 'LIST_DETA2';
            obj1.idgrupo = localStorage.getItem('idGrupo');
            obj1.vcitem = localStorage.getItem('num_combinacion');
            console.log('2392');
            console.log(obj1);
            $.ajax({
                type: 'POST',
                ...
                success: function (data) {
                    var lst = JSON.parse(data.d)
                    almacenarLocalStorage('listaCantidad', lst.length);
                    console.log('2919');
                    console.log(lst);
                    if (lst.length > 0) {

                        //seteamos
                        $("#list_traba_labor_asig_bd").empty();
                        var list_grupo = ''
                        list_grupo += '<div class="col-md-12 mt-2  rounded border-left-3 border-info AA">';

                        for (var i = 0; i < lst.length; i++) {

                            if (lst[i].DHORAINICIO != "0000" && lst[i].DHORAFIN != "0000") {
                                estado = 'GUARDADO';
                            }
                            var listahorainicio = lst[i].DHORAINICIO.split('');
                            var horainicio = listahorainicio[0] + listahorainicio[1] + ':' + listahorainicio[2] + listahorainicio[3];
                            var listahorafin = lst[i].DHORAFIN.split('');
                            var horafin = listahorafin[0] + listahorafin[1] + ':' + listahorafin[2] + listahorafin[3];
                            console.log(lst[i].DHORAINICIO + '           ' + lst[i].DHORAFIN);
                            ...
                            list_grupo += '<input class="form-control A' + i + '" type="text" id="datos_trabajador' + i + '" value="' + lst[i].DATOS_TRAB + '" disabled/>';
                            list_grupo += '<input type="hidden" id="cod_tareo" value="' + lst[i].IDTAREO + '"/>';
                            list_grupo += '</div>';
                            list_grupo += '<div class="col-sm-6">';
                            list_grupo += '<label><b>Numero Documento</b></label>';
                            list_grupo += '<input class="form-control A" type="text" id="id_trab_por_labor' + i + '" value="' + lst[i].COD_TRAB + '" disabled/>';
                            list_grupo += '<input type="hidden" id="cod_grupo_citemid" value="' + lst[i].ITEM + '"/>';
                            list_grupo += '</div>';
                            list_grupo += '</div>';
                            list_grupo += '<div class="row">';
                            list_grupo += '<div class="col-sm-3">';
                            ...
                            list_grupo += '<input type="time" class="form-control A" id="comb_trab_hora_inicio' + i + '" value="' + horainicio + '" aria-describedby="basic-addon3">';
                            list_grupo += '</div>';
                            list_grupo += '</div>';
                            list_grupo += '</div>';
                            list_grupo += '<div class="col-sm-3">';
                            ...
                            list_grupo += '<div class="input-group-prepend">';
                            list_grupo += '<span class="input-group-text" id="basic-addon3"><i class="fa fa-calendar"></i></span>';
                            list_grupo += '<input type="time" class="form-control A" id="comb_trab_hora_fin' + i + '" value="' + horafin + '" aria-describedby="basic-addon3">';
                            list_grupo += '</div>';
                            list_grupo += '</div>';
                            list_grupo += '</div>';
                            //list_grupo += '<div class="col-sm-1">';
                            ...
                            list_grupo += '<div class="input-group mb-3">';
                            list_grupo += '<div class="input-group-prepend">';
                            list_grupo += '<button type="button" class="btn btn-success editarJornal"  dni="' + lst[i].COD_TRAB + '" idTareo="' + lst[i].IDTAREO + '"  contador="' + i + '"><i class="fa fa-refresh"></i></button>';
                            list_grupo += '</div>';
                            list_grupo += '</div>';
                            list_grupo += '</div>';
                            list_grupo += '<div class="col-sm-1">';
                            ...
                            list_grupo += '<div class="input-group mb-3">';
                            list_grupo += '<div class="input-group-prepend">';
                            list_grupo += '<button type="button" class="btn btn-danger eliminarJornal" dni="' + lst[i].COD_TRAB + '" idTareo="' + lst[i].IDTAREO + '" contador="' + i + '"><i class="fa fa-trash"></i></button>';
                            list_grupo += '</div>';
                            list_grupo += '</div>';
                            list_grupo += '</div>';
                            list_grupo += '</div>';
                        ...
                        if (localStorage.getItem('tipoLabor') == 2) {
                            list_grupo += '<button type="button" class="btn btn-danger" onclick="listar_trabajador_labor(' + localStorage.getItem('num_combinacion') + ')">SIGUIENTE</i></button>';
                        ...
                        $("#list_traba_labor_asig_bd").empty();
                        toastr["error"]("NO SE ENCONTRARON TRABAJADORES \n REF: listar_trabajador_x_labor");
                    }
                },
                error: function (data) {
        ...
        function redireccionar(tipo, grupo) {
            ...
            almacenarLocalStorage('tipoLabor', tipo);
            //if (tipo == 1) {
            //    listar_traba_por_labor(grupo);
            //}
            //if (tipo == 2) {
        ...
        function listar_traba_por_labor(num_grupo) {
            ...
            almacenarLocalStorage('num_combinacion', item_ultim);
        ...
        function listar_trabajadores_jornales_erick(){
            $('#profile-tab2').prop('disabled', false);
            $('#contact-tab5').prop('disabled', false);
            var variableLocal = localStorage.getItem('listaCantidad');
            var nroGrupo = localStorage.getItem('num_combinacion');
            var horaInicio = $('#hora_inicio_asig').val();
            var horaFin = $('#hora_fin_asig').val();
            var idtareo = document.getElementById("id_responsable").value;
            
            var obj1 = new Object();
            obj1.CTCTG20TARID = idtareo;
            obj1.CTCTG30TRABID = '';
            obj1.CTCITEM = nroGrupo;   // numero de grupo
            obj1.CTDHORAINICIO = horaInicio;
            obj1.CTDHORAFIN = horaFin;
            console.log('2185');
            console.log(obj1);
            $.ajax({
                type: 'POST',
        ...
        function listar_trabajador_labor(num_grupo) {
            ...
            obj.vtareocabtipo = tipo;
            obj.vtitem_ini = localStorage.getItem('num_combinacion');
            obj.idResponsable = '';
            $.ajax({
                type: 'POST',
                url: "../SerTareo.asmx/SER_listar_tareo",
        ...
        function asignar_hora_masiva() {
            listar_trabajadores_jornales_erick();
        ...
        $(document).on('click', '.editarJornal', function (e) {
            var contador = $(this).attr('contador');
            var cod_tareo = document.getElementById("id_responsable").value;
            var dni = $('#id_trab_por_labor' + contador).val();
            var CDitemID = localStorage.getItem('num_combinacion');
            var hora_inicio = $('#comb_trab_hora_inicio' + contador).val();
            var hora_fin = $('#comb_trab_hora_fin' + contador).val();
        ...
        function registrar_rendimiento_labor() {
            ...
            var grupo_dni = $("#list_rend_grupo").dxSelectBox('instance').option('selectedItem').NRODOCUMENTO;
            ...
            obj.AVCITEMID = localStorage.getItem('num_combinacion'); //  +grupo
            $.ajax({
                type: 'POST',
                ...
                success: function (data) {
                    ...
                    listar_trabajador_labor(localStorage.getItem('num_combinacion'));
                },
                error: function (data) {
                    //toastr["success"]("SE REGISTRO DATOS");
                    //$('#exampleModal6').modal('hide');
        ...
        function buscarDniEnRendimiento() {
            var obj = new Object();
            var vctg30targrupoid = document.getElementById("id_responsable").value;;
            var AVCITEMID = localStorage.getItem('num_combinacion');
            var nombre = $('#buscarDniTrabajadorGrupo').val();
            if (nombre.length != 0) {
                var obj = new Object();
                obj.vctg30targrupoid = vctg30targrupoid;
                obj.AVCITEMID = AVCITEMID;
                obj.nombre = nombre;

                $.ajax({
                    type: 'POST',
                    url: "../SerTareo.asmx/BuscarNombreporDni",
                    data: JSON.stringify({ obj: obj }),
                    dataType: 'json',
                    contentType: 'application/json; charset=utf-8',
                    //beforeSend: function () {
                    ...
                    success: function (data) {
                        ...
                        if (lst.length > 0) {
                            ...
                            for (var i = 0; i < lst.length; i++) {
                                ...
                                trow += '<div class="card-body text-dark">';
                                trow += '<label><b>DNI</b></label>';
                                trow += '<p id="rend_dni">' + lst[i].NRODOCUMENTO + '</p>';
                                trow += '</div>';
                                trow += '</div>';
                                ...
                                trow += '<div class="col-sm-2">';
                                trow += '<div class="card-body text-dark">';
                                trow += '<button type = "button" class="btn btn-warning" data-toggle="modal" data-target="#exampleModal20" onclick="listar_update_avance_trabajador(' + lst[i].CITEM + ')">';
                                trow += '<i class="fa fa-edit"></i>';
                                trow += '</button>';
                                trow += '</div>';
                                trow += '</div>';
                            ...
                            listar_trabajador_labor(AVCITEMID);
                        }
        ...
        $(document).on('click', '.eliminarJornal', function (e) {
            var contador = $(this).attr('contador');
            var cod_tareo = document.getElementById("id_responsable").value;
            var dni = $('#id_trab_por_labor' + contador).val();
            var CDitemID = localStorage.getItem('num_combinacion');
