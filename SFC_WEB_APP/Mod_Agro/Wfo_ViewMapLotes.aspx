<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Wfo_ViewMapLotes.aspx.cs" Inherits="SFC_WEB_APP.Mod_Agro.ViewMapLotes" %>
                            ...
                            if (id != '')
                            {
                                $.ajax({
                                    ...
                                    success: function (data)
                                    {
                                        ...
                                        $("#accordion").html('');
                                        var id_px = {id_p: data.id, ambito: 1};
                                        carga_doc(id_px);
                                    }
                                })
                            } else {
