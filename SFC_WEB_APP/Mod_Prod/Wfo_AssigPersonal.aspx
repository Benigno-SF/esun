...
<asp:Content ID="Content3" ContentPlaceHolderID="Body" runat="server">
    ...
    <script>
        ...
        $("#btnAdd").click(function () {
            ...
            obj.vcFechaNacimiento = hoy;
            obj.vcFechaRegistro = hoy;
            if (obj.vcNroDocumento != '' && obj.vcNroDocumento.length == 8) {
            if (obj.vcNombres != '' && obj.vcApPaterno != '' && obj.vcApMaterno != '' && obj.vcCodigoLabor != 0) {
            ...
            if (obj.vcNroDocumento != '' && obj.vcNroDocumento.length == 8) {
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        if (lst != "") {
                            if (lst[0].cIdPlanilla == 'OAC' || lst[0].cIdPlanilla == '') {
                                toastr.remove();
                                toastr.clear();
                                ...
                                toastr.warning('Agregara un Personal de Campo o sin codigo de planilla', 'INFORMACION ENCONTRADA');
                            ...
                            var urlphp = "http://204.199.164.94/reniec/index.php?dni=" + obj.vcNroDocumento;
                            $.ajax({
                                type: 'POST',
                                url: urlphp,
                               // data: { obj: query2, urlrv: urlsag },
                                ...
                                beforeSend: function () {
                                    toastr.remove();
                                    toastr.clear();
                                    toastr.warning('', 'ACCEDIENDO RENIEC, BUSCANDO INFORMACION ....');
                                },
                                success: function (data1) {
                                    if (data1 != '') {
                                        if (data1[0].success == true) {
                                            ...
                                            toastr.remove();
                                            toastr.clear();
                                            $('#nombres').val(data1[0].data.nombres);
                                            $('#a_paterno').val(data1[0].data.apellido_paterno);
                                            $('#a_materno').val(data1[0].data.apellido_materno);
