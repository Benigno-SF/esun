<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Wfo_AvancePersonal.aspx.cs" Inherits="SFC_WEB_APP.Mod_Prod.Wfo_AvancePersonal" %>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Avance de Personal</h4>
        ...
        function cargatabla() {
            ...
            if (obj.vcIdEmpresa != '' && obj.vnIdArea != 0) {
                if (obj.vcNroDocumento != '' || obj.vcNombres != '') {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: "../SerProd.asmx/RendimientoProcesoRegistroAvanceUser",
        ...
        function TbDataGrid(data, vfecha) {
            ...
            var dataGrid = $("#DataGrid").dxDataGrid({
                ...
                columns: [
                    ...
                    , { caption: "H_inicio", dataField: "H_inicio" }
                    , { caption: "H_final", dataField: "H_final" }
                    , { caption: "tiempo_trabajo", dataField: "tiempo_trabajo" }
                    , { caption: "anulados", dataField: "anulados", dataType: "number",  }
                    , { caption: "etiquetas", dataField: "etiquetas", dataType: "number",  }
                    , { caption: "total", dataField: "total", dataType: "number",  }
                ],
