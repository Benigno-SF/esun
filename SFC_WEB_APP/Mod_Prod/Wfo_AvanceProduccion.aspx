<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Wfo_AvanceProduccion.aspx.cs" Inherits="SFC_WEB_APP.Mod_Prod.Wfo_AvanceProduccion" %>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Reporte Detalle de Proceso</h4>
            ...
            var dataGrid = $("#DataGrid").dxDataGrid({
                ...
                columns: [
                   ...
                   // , { caption: "cRuc", dataField: "cRuc" }
                    ...
                    , { caption: "personas", dataField: "personas" }
                    , { caption: "cajas", dataField: "cajas" }
                    , { caption: "tapers", dataField: "tapers" }
                    , { caption: "cajasxhora", dataField: "cajasxhora" }
                    , { caption: "tiempo trabajo", dataField: "tiempo_trabajo" }
                    , { caption: "kilos_abastecidos", dataField: "kilos_abastecidos" }
                    , { caption: "inicio", dataField: "H_inicio" }
                    , { caption: "fin", dataField: "H_final" }
                    //fecha	id	nIdGrupo	linea	cNomHisp	cRuc	cDescClieProv	cDesEmbalaje	cDescVariedad	personas	Clamshell	Embalaje	Seleccion	cajas	tapers	horas	minutos	cajasxhora	clamshellxhora	cajasxhorauser
                    //clamshellxhorauser	H_inicio	H_final	tiempo_trabajo	tiemposinleer	tiempo_parada	inicio	fin	supervisor	kilos_abastecidos	totalcajas	totalkilos	porcentajekilos	porcentajecajas
