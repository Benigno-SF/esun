                    ...
                    success: function (data) {
                        ...
                        for (i = 0; i < lst.length; ++i) {
                            if (lst[i].dFechaSalida == null && lst[i].dFechaRegiSalida == null) {
                                plt += lst[i].jabas;
                                vvtb += "<tr><td>" + lst[i].cDescripcion + "</td><td>" + lst[i].cPlaca + "</td><td><i class='fas fa-cubes'></i> " + lst[i].cDescClieProv + "</td><td>" + lst[i].guias + "</td><td>" + lst[i].variedades + "</td><td>" + lst[i].FechaIngreso + "</td><td>" + lst[i].HIngreso + "</td><td>" + lst[i].transcurrido + " Horas</td><td><i class='fas fa-weight-hanging'></i> " + lst[i].jabas + "</td></tr>";
                            }
                        }
                        $("#lblpalets").html('<b></b>');
