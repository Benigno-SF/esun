<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Wfo_Inscripcion_Personal.aspx.cs" Inherits="SFC_WEB_APP.Mod_App.Wfo_IncripcionPersonal" %>
        ...
        <div style="">
            ...
            <form id="needs-validation" class="needs-validation" novalidate="novalidate">
                ...
                <div class="row" id="rowform">
                    ...
                    <div class="col-md-4">
                        <div class="row">
                            <div class="form-group col-md-12">
                                <label for="message-text" class="label-input">Direccion Actual:</label>
                        ...
                        <div class="row">
                            <div class="form-group col-md-12">
                                <label for="mes age-text" class="label-input">Agrega Foto:(de frente, sin mascarilla)</label> <button type="button" class="btn btn-link btn-help" data-toggle="tooltip" data-placement="right" data-html="true" title="<div><img src='img/add-img.gif' width='390'  height='390'></div>" ><i class="fas fa-question-circle"></i></button><br />
                    ...
                    <div class="col-md-4">
                        <div class="row">
                            <div class="form-group col-md-12">
                                <label for="message-text" class="label-input">Turno de preferencia:</label>
                                <select id="turno" name="turno" class="form-control" required="required">
                                    <option value="" disabled selected>- selecciona -</option>
                                    <option value="1">MAÑANA</option>
                                    <option value="2">NOCHE</option>
                                </select>                                
                                <div class="invalid-tooltip">Seleccione turno</div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group col-md-12">
                        ...
                        <div class="form-group mt-4 mb-3" style="padding: 2px;">
                            ...
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="trsf" id="trsf1" value="1" required="required"/>
                                ...
                                <div class="invalid-tooltip">Click en una opcion</div>
                            </div>
                        </div> 
                        <div class="row">
                            <div class="form-group col-md-12 sts" style="display: none">
                                <label for="message-text" class="label-input">Años que laboró: <button type="button" class="btn btn-link btn-help" data-toggle="tooltip" data-placement="right" data-html="true" title="<div><img src='img/add-year.gif' width='300'  height='400'></div>" ><i class="fas fa-question-circle"></i></button></label>
                            ...
                            <div class="form-group col-md-12 nts" style="display: none">
                                <label for="txtFeCont" class="label-input" id="t-cc">Campañas que laboró: </label><button type="button" class="btn btn-link btn-help" data-toggle="tooltip" data-placement="right" data-html="true" title="<div><img src='img/add-campana.gif' width='300'  height='400'></div>" ><i class="fas fa-question-circle"></i></button>
                            ...
                            <div class="form-group col-md-12 nts" style="display: none">
                                <label for="message-text" class="label-input" id="t-crc">Labores desempeñadas: </label><button type="button" class="btn btn-link btn-help" data-toggle="tooltip" data-placement="right" data-html="true" title="<div><img src='img/add-labor.gif' width='300'  height='400'></div>" ><i class="fas fa-question-circle"></i></button>
            ...
            <div id="subtitle" class="row justify-content-md-center pt-4 pb-4">
                <div class="col-md-6 text-white text-center">
                    ...
                    <p class=" mb-0">PLANTA - <a href="tel:+972148898">972 148 898</a></p>
                    <p class=" mb-0">Escribenos a:</p>
                    <p class=" mb-0"><a href="mailto:recursoshumanos@sunfruits.com.pe">recursoshumanos@sunfruits.com.pe</a></p>
                </div>
            </div>
        </div>
    </div>
