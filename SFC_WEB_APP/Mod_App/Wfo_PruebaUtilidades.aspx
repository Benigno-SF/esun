<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Wfo_PruebaUtilidades.aspx.cs" Inherits="SFC_WEB_APP.Mod_App.Wfo_PruebaUtilidades" %>
...
<%--                    <p class="lead mb-3 font-weight-bold text-white" id="name"></p>
            ...
            <div id="mdes" class="col-md-6" style="display: none">
                <div class="col-md-auto text-white text-center">
                    <p class="lead mb-0">ESTE SERVICIO ESTARA ACTIVO DESDE EL 25 DE ABRIL DEL 2022</p>
                </div>
            </div>
                                    ...
                                    <table style="width: 100%; font-size: 0.8rem;">
                                        <tbody>
                                            ...
                                            <tr class="text-center">
                                                <td colspan="2">
                                                    <br />
                                                    <span style="font-weight: bold; font-size: 1rem; font-family: 'PRVPIC+CIDFont+F2'">PARTICIPACION EN LAS UTILIDADES POR EL EJERCICIO GRAVABLE<br />
                                                        AÑO <span class="anio"></span></span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="padding: 0px 20px 0px 20px">
                                                ...
                                                <td colspan="2" style="padding: 0px 20px 0px 20px">
                                                    ...
                                                    <table style="width: 100%; border: 1px; border-color: black; border-style: outset; padding: 0px 20px 0px 20px; font-size: 0.7rem">
                                                        <tbody style="padding: 20px; display: block">
                                                            ...
                                                            <tr style="width: 100%; display: table;">
                                                                <td style="width: 80%">3. Días laborados por todos los trabajadores en el año <span class="anio"></span> (enero - diciembre)  </td>
                                                                <td style="width: 10%">S/.</td>
                                                                <td id="vc5" style="width: 20%; text-align: right;"></td>
                                                            </tr>
                                                            <tr style="width: 100%; display: table;">
                                                                <td style="width: 80%">4. Días laborados por el trabajador en el año <span class="anio"></span> (enero - diciembre) </td>
                                                                <td style="width: 10%">S/.</td>
                                                                <td id="vc6" style="width: 20%; text-align: right"></td>
                                                            </tr>
                                                            <tr style="width: 100%; display: table;">
                                                                <td style="width: 80%">5. Remuneraciones percibidas por todos los trabajadores en el año <span class="anio"></span> (enero - diciembre)</td>
                                                                <td style="width: 10%">S/.</td>
                                                                <td id="vc7" style="width: 20%; text-align: right"></td>
                                                            </tr>
                                                            <tr style="width: 100%; display: table;">
                                                                <td style="width: 80%">6. Remuneraciones percibidas por el trabajador en el año <span class="anio"></span> (enero - diciembre)</td>
                                                                <td style="width: 10%">S/.</td>
                                                                <td id="vc8" style="width: 20%; text-align: right"></td>
                                                            </tr>
                                                            <tr style="width: 100%; display: table;">
                                                                <td style="width: 80%">7. A distribuir por los dias laborados en el año <span class="anio"></span> (enero - diciembre)</td>
                                                                <td style="width: 10%">S/.</td>
                                                                <td id="vc9" style="width: 20%; text-align: right"></td>
                                                            </tr>
                                                            <tr style="width: 100%; display: table;">
                                                                <td style="width: 80%">8. A distribuir por las remuneraciones percibidas en el año <span class="anio"></span> (enero - diciembre)</td>
                                                                <td style="width: 10%">S/.</td>
                                            ...
                                            <tr>
                                                <td colspan="2" style="padding: 0px 20px 0px 20px">
                                                    ...
                                                    <table style="width: 100%; border: 1px; border-color: black; border-style: outset; padding: 0px 20px 0px 20px; font-size: 0.7rem">
                                                        <tbody style="padding: 20px; display: block">
                                                            <tr style="width: 100%; display: table;">
                                                                <td style="width: 80%; font-size: 1rem; font-weight: bold; font-family: 'PRVPIC+CIDFont+F2'">LIQUIDACION DE LA PARTICIPACION DE UTILIDADES
                                                                    <br />
                                                                </td>
    ...
    <script type="text/javascript">
                            ...
                            switch (lst[0].rpta) {
                                ...
                                case 1:
                                    ...
                                    if (lst[0].email != '' & lst[0].email != 'rrhh@sunfruits.com.pe' & lst[0].email != 'sferrhh@gmail.com') {
                                        ...
                                        $("#mail").text('USTED NO TIENE CORREO REGISTRADO, POR FAVOR INGRESE SU CORREO PARA PODER ACTUALIZARLO');
                                        $('#div-boton').show();
                                        $('#btn-No-Email').hide();
                                        $('#Email_New').show();
                                        $("#btn-Send").val('Enviar a RRHH');
       ...
       // cargaplantilla('72530386');
        ...
        function ComboAno() {
            ...
            for (var i = 2003; i >= 1960; i--)selectfn.options.add(new Option(i, i));
        };
        ComboAno();
        var clearform;
        var clear;
