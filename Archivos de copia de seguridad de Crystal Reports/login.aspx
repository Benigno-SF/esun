            ...
            <div class="modal-content">
                <div class="modal-body">
                    <div class="row text-center">
                        <div class="col">
                            <a href="Mod_App/Wfo_MonitorComedor.aspx" class="text-dark text-center"><i class="fas fa-utensils"></i><br />Horario Comedor</a>
                        </div>
                        <div class="col">
                            <a href="Mod_App/Wfo_MoniLine.aspx" class="text-dark text-center"><i class="fa fa-tv"></i><br />Monitor Lineas</a>
                        </div>
                        <div class="col">
                        ...
                        <div class="col">
                            <a href="Mod_App/Wfo_MoniRend.aspx" class="text-dark text-center"><i class="fa fa-tv"></i><br />Monitor Rendimiento</a>
                        </div>
                        <div class="col">
