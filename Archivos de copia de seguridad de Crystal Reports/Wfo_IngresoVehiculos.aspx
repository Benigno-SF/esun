...
<asp:Content ID="Content4" ContentPlaceHolderID="Body" runat="server">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group mb-1" id="idVehiculo">
                        ...
                        <div class="input-group">
                            <input type="text" id="cPlaca" class="form-control round" placeholder="Ingrese Placa de Vehiculo" onkeyup="document.getElementById(this.id).value=document.getElementById(this.id).value.toUpperCase(); v_Placa(this.value, 'E')">
    ...
    <script type="text/javascript" charset="UTF-8">
        ...
        function Buscar_Cliente(RUC) {
            var obj = new Object();
            obj.cRuc = RUC;
            if (obj.cRuc != '' || obj.cRuc.length >= 11) {
                $('#cDescCliente').blur();
                $.ajax({
                    type: 'POST',
                    url: "../SerSegu.asmx/listConductor",
